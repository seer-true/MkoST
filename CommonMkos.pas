...
const
  RealTasks: array [0 .. 3] of string = ('SearchFiles', 'SearchPattern', (* 'SearchPattern2', *) 'ArchiveFolder', 'ArchiveFolderAPI');

var
  FSearchDLL: THandle;
  FZIPDLL: THandle;
  SevenZipPath: String = 'C:\Program Files\7-Zip\7z.exe'; //Стандартный путь, можно изменить
